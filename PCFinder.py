...
while True:
    title = "PC Finder"
    msg_inicio = 'Seja Bem-vindo, esse é o PcFinder, o aplicativo que te ajuda a escolher o Computador ideal para você! \nEscolha o que deseja fazer:'
    opcoes_inicio = ['Escolher o Computador ideal', 'Ver as lojas recomendadas', 'Ajuda', 'Sair']
    images = 'PCFinder.png'

    dispatcher = ei.buttonbox(msg_inicio, title, opcoes_inicio,images)

    if dispatcher == opcoes_inicio[0]:
        ...
        if escolha == perfis[0]:
            ...
            if valor == "2.500 a 4.000":
                if variacao == 'Intel/NVIDIA':
                    ...
                    if yn == 1:
                        webb.open(
                            'https://www.terabyteshop.com.br/produto/6882/PC-Gamer-T-Soldier-LVL-2-Intel-Placa-de-Video-Memoria-HD-Fonte-Gabinete')
                    exit()
                if variacao == 'Intel/AMD':
                    ...
                    if yn == 1:
                        webb.open(
                            'https://www.pichau.com.br/computadores/pichau-gamer/computador-pichau-gamer-i3-7100-amd-radeon-rx-550-2gb-8gb-hd-1tb-400w-mt-g600bk')
                    exit()
                if variacao == 'AMD/AMD':
                    ...
                    if yn == 1:
                        webb.open(
                            'https://www.pichau.com.br/computadores/pichau-gamer/computador-pichau-gamer-fx-8300-redeon-rx-570-4gb-8gb-hd-1tb-400w-si-5100')
                    exit()
                if variacao == 'AMD/NVIDIA':
                    ...
                    if yn == 1:
                        webb.open(
                            'https://www.terabyteshop.com.br/produto/8027/PC-Gamer-T-COMMANDER-LVL-2-AMD-Ryzen-5-1500x-Placa-de-Video-Nvidia-GeForce')
                    exit()
            if valor == "4.000 a 5.500":
                if variacao == 'Intel/NVIDIA':
                    ...
                    if yn == 1:
                        webb.open(
                            'https://www.terabyteshop.com.br/produto/6909/PC-Gamer-T-Captain-LVL-3-Intel-Placa-de-Video-Memoria-HD-Fonte-Gabinete')
                    exit()
                if variacao == 'Intel/AMD':
                    ...
                    if yn == 1:
                        webb.open(
                            'https://www.pichau.com.br/computadores/pichau-gamer/computador-pichau-gamer-i7-7700-xfx-radeon-rx-580-gts-8gb-8gb-ddr4-hd-1tb-500w-spec-03')
                    exit()
                if variacao == 'AMD/NVIDIA':
                    ...
                    if yn == 1:
                        webb.open(
                            'https://www.terabyteshop.com.br/produto/8010/PC-Gamer-T-Captain-LVL-3-AMD-Ryzen-5-1600-Placa-de-Video-Nvidia-GeForce')
                    exit()
                if variacao == 'AMD/AMD':
                    msg = 'Processador: \n Placa de Video: \n' \
                          'Memoria ram: Gb DDR4 \n Disco rigido: Tb \n\n Preço: \n\n Acessar o link do PC Proposto?'
            ...
            if valor == "5.500 a 7.000":
                if variacao == 'Intel/NVIDIA':
                    ...
                    if yn == 1:
                        webb.open(
                            'https://www.terabyteshop.com.br/produto/8486/PC-Gamer-T-Power-General-LVL-3-8-gen-Intel-Placa-de-Video-Memoria-HD-Fonte-Gabinete')
                    exit()
                if variacao == 'Intel/AMD':
                    ...
                    if yn == 1:
                        webb.open(
                            'https://www.pichau.com.br/computadores/pichau-gamer/computador-pichau-gamer-i5-7400-xfx-radeon-rx-580-gts-8gb-8gb-ddr4-hd-1tb-500w-spec-03')
                    exit()
                if variacao == 'AMD/NVIDIA':
                    ...
                    if yn == 1:
                        webb.open(
                            'https://www.terabyteshop.com.br/produto/8122/PC-Gamer-T-Power-Warlord-LVL-3-AMD-Ryzen-Placa-de-Video-Memoria-HD-Fonte-Gabinete')
                    exit()
                if variacao == 'AMD/AMD':
        ...
        if escolha == perfis[3]:
            ...
            if tipo == "WINDOWS":
                ...
                if variacao == "4.000 a 8.000":
                    ...
                    exit()
    if dispatcher == opcoes_inicio[1]:

        msg = "As lojas que recomendamos para você adquirir o seu computador são:"
        choices = ["KABUM!", "TeraByte", "Pichau"]
        site = ei.buttonbox(msg,title,choices)

        if site == choices[0]:
            webb.open("https://www.kabum.com.br")
        if site == choices[1]:
            webb.open("https://www.terabyte.com.br")
        if site == choices[2]:
            webb.open("https://www.pichau.com.br")
    if dispatcher == opcoes_inicio[2]:

        msg = "Como Funciona? \n O Pc Finder foi criado com alguns modelos de computador salvos em seu codigo, \n" \
              " atendendo a pré requisitos estipulados por você, buscamos o Pc que melhor atende as suas necessidades!\n" \
              "Esperamos ajudar... "
        choices = ["Voltar", "Sair"]
        botao = ei.buttonbox(msg,title,choices)

        if botao == choices[1]:

            exit()

    if dispatcher == opcoes_inicio[3]:
        exit()
